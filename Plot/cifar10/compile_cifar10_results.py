...
# 【核心修改】使用 os.path.join 方便控制
result_dir = os.path.join("Results", DATASET_NAME, "Nature_Attack")
output_dir = os.path.join("Results", DATASET_NAME, "Comparison", "CSV")
...
# 【自定义模型显示名称】映射
MODEL_DISPLAY_NAME = {
    "WideResNet_28-10": "WRN-28-10",
    "Carmon2019": "Carmon2019",
    "Augustin2020": "Augustin2020",
}
...
for model in MODELS:
    ...
    display_model_name = MODEL_DISPLAY_NAME.get(model, model)
